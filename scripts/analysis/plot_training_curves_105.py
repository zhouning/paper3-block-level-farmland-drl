# -*- coding: utf-8 -*-
"""Training curves for Paper 3 Block-Level DRL (Township 105, 5 seeds)."""
...
LOG_DIR = BLOCK_RESULTS_DIR / 'township_500227105'
...
baselines_ref = {
    'slope_change_pct': [
        (-1.17, 'Greedy-Seq', '#FF9800'),
        (-1.48, 'Greedy-Global', '#E53935'),
    ],
    'cont_change': [
        (0.020, 'Greedy-Seq', '#FF9800'),
        (0.121, 'Greedy-Global', '#E53935'),
    ],
    'baimu_area_change_ha': [
        (-43.0, 'Greedy-Seq', '#FF9800'),
        (+34.6, 'Greedy-Global', '#E53935'),
        (+114.4, 'Round-Robin', '#4CAF50'),
    ],
}
...
plt.suptitle('Township 105 (C-Large): Training Curves — 200K Steps x 5 Seeds\n'
